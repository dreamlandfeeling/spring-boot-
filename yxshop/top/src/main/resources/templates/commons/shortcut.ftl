<script>
    $(function () {
        ...
        $('#toLogin').attr("href","/user/login?redirect="+redirect);
    });
</script>
<div class="topMenu">
  <div class="pW">
    ...
    <ul class="fr topTh">
      ...
      <li class="myOrder"><a name="sfbest_hp_hp_head_OrderList" class="trackref" href="/order/" rel="nofollow">我的订单</a></li>
      <li class="menus">
        <a name="sfbest_hp_hp_head_home1" href="http://home.e3mall.cn/my/index/" rel="nofollow" class="trackref t">我的优选</a><b></b>
        <span class="outline"></span>
        <span class="blank"></span>
        <div class="dd">
          <div><a name="sfbest_hp_hp_head_home2" class="trackref" href="/order/" rel="nofollow">我的订单</a></div>
