...
<div class="slide_show" id="slide_show">
        ...
        <div id="index_slide" class="slide_wrap">
            <ol>
                <#list contents as content>
                    <li>
                        <a name=${content.title} class="fore_pic trackref" href=${content.url}
                        target="_blank">
                        <img id="lunbo_${content_index}" alt=${content.title} src=${content.pic}>
                        </a>
                    </li>
            </#list>
              <!--<li>
                    <a name="sfbest_hp_hp_focus_1" class="fore_pic trackref" href="/html/activity/1471934470.html"
                       target="_blank">
    ...
    <ul class="none" id="lunboNum">
        <#list 1..contentNum as t>
            <#if t=1><li class="cur">${t}</li>
            <#else><li class="">${t}</li>
            </#if>
        </#list>
        <#--<li class="cur">1</li>-->
