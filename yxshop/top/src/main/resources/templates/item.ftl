            ...
            <div class="pItemsMain">
                <div class="pItemsName">
                    <div class="cm">
                        ...
                        <strong id="adword-sf" title="" class="">${item.sellPoint?default("") }</strong>
                    </div>
                </div>
                ...
                <div class="pItemsChoose">
                    ...
                    <div class="chooseBtns" id="buy-btn-sf">
                        <form id = "itemForm" action="/cart/" method = "post">
                            <input type="hidden" name="productId" value="${item.id?c}">
                            <div class="pAmount">
                                <span><input type="text" name="num" id="number_${item.id?c}" class="text" value=""></span>
                                <span>
                        ...
                        <div class="pBtn" id="cart-add-btn-sf"><a
                                onclick="formSubmit();"><b></b>加入购物车</a></div>
                        <div class="pBtn quickBuy" style="display: none;" id="quickBuy" title="快速下单，直达填写订单页面"><a
                                onclick="oneKeyBuy(${item.id?c}, 0, 1, 0, 1, this);">一键购买</a></div>
            ...
            <div class="pView">
                <div id="pView">
                    <div id="zoom-jpg" class="jqzoom">
                        <img id="bigImage"  width="330" height="330" src="${item.images[0] }" jqimg="${item.images[0] }"/>
                    </div>
                    <div id="pic-list">
                        ...
                        <div class="pic-items"
                            ...
                            <ul style="position: absolute; left: 0px; top: 0px; height: 240px;">
                                <#list item.images as image>
                                    <li style="float: left;" >
                                        <img onclick="changeImg('${image}')"src="${image}">
                                    </li>
                                </#list>
                            </ul>
                        </div>
...
<div class="pWrap">
    <div class="main-box">
        ...
        <div class="pCont cpjs_box" id="div-detail">
            ...
            <div class="product_info">${itemDesc.itemDesc?default("暂无商品详情") }</div>
        </div>
        <div class="pCont" id="div-comment">
            <div class="commentList" id="commandp">
                ...
                <div class="plpage">
                    <div class="showAll" style="display: none;"><a target="_blank" href="/reviewlist/0/${item.id?c}">[查看全部评价]</a>
                    </div>
